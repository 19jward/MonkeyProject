...
optim_cov_ll_b1 <- function(data, X, behavior_list, beta_starting_behavior, num_cov, maxit = 5000){
...
which habitat is habitat 1

add new functions to their own script files in package folder
roxygen
adding examples

documentation & simulate data where i know the "correct" betas

make a function for simulate data

X is FxM
betas is MxBxB full array
sim_data <- function(X, beta){

get behavior list from dim names
behavior_list <- dimnames(beta)[2]

return(sequence of behaviors w/durations)
}

fit and simulate functions are like inverses of each other