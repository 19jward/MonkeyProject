...
get_LL <- function(data, P){
  ## define the variables we need for the likelihood
  y1 <- data$Behavior[1] # first listed behavior in the provided data
  p1 <- c(rep(1/12, 12)) #probability of starting behavior (doing uniform for now)
  
  # t <-  (is t our index for a for loop?) --> index for loop over time (using duration?)
  # yt <-  vector of 0s and 1s that tell us what behavior we are at (idk how to this) dummy variable?
...
- idk how to do the yt vector that tells us which behavior it is in time t w/vector of 0s and 1
  - basically just doing a dummy variable
